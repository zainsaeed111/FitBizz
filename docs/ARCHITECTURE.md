...
### 2. Next.js Web SaaS Application (`fitbizz_web/`)
* **Platform Strategy**: Next.js App Router (TypeScript, Tailwind CSS) hosting the Super Admin SaaS Platform & Web Portal.
* **Super Admin Features**: Platform analytics dashboard, multi-step Gym Onboarding Wizard (with dynamic multi-branch builder and 15-day trial setup), and tenant management.

### 3. Spring Boot Backend (`fitbizz_backend/`)
